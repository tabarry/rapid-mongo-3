                            ...
                            <form style="display:none" name="suForm_<?php echo $i; ?>" action="step4.php" method="post" id="suForm_<?php echo $i; ?>" target="remote_<?php echo $i; ?>" onsubmit="return validate3('suForm_<?php echo $i; ?>');">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpading="0">
                                    <tr>
                                        ...
                                        <td class="rowHeader" width="24%">Show, Search, Order by, Display as, Resize</td>
                                        ...
                                        <?php if ((!stristr($row[0], '__Last_Action_On')) && (!stristr($row[0], '__Last_Action_By')) && (!stristr($row[0], '__dbState'))) { ?>
                                            <tr <?php echo $hide; ?>>
                                                ...
                                                <td class="rowData" width="24%">
                                                    ...
                                                    <input type="checkbox" name="frmShow[]" id="frmShow" value="<?php echo $row[0]; ?>" <?php echo $disable_show_checkbox; ?> <?php echo $showChk; ?> />
                                                    
                                                    <input name="frmSearch" id="frmSearch" type="radio" <?php echo $chkRadio; ?> value="<?php echo $row[0]; ?>" />
