...
//update record
    ...
    $col = $db->sulata_pages;
    $data = array('$set' => array('page__Name' => suStrip($_POST['page__Name']), 'page__Name_slug' => suSlugifyString($_POST['page__Name']), 'page__Heading' => suStrip($_POST['page__Heading']), 'page__Permalink' => suSlugifyName(suStrip($_POST['page__Permalink'])), 'page__Title' => suStrip($_POST['page__Title']), 'page__Keyword' => suStrip($_POST['page__Keyword']), 'page__Description' => suStrip($_POST['page__Description']), 'page__Header' => suStrip($_POST['page__Header']), 'page__Short_Text' => suStrip($_POST['page__Short_Text']), 'page__Long_Text' => suStrip($_POST['page__Long_Text']), 'page__Sequence' => suStrip($_POST['page__Sequence']), 'page__Last_Action_On' => new MongoDate(strtotime(date('Y-m-d H:i:s'))), 'page__Last_Action_By' => $_SESSION[SESSION_PREFIX . 'user__Name'], 'page__dbState' => 'Live'));
    $data = array_merge($data, $extraSql);
