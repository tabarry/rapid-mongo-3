...
$pageName = 'Update Testimonials';
$pageTitle = 'Update Testimonials';
?>
<!DOCTYPE html>
<html>
    <head>
                    ...
                    <div class="container">
                        ...
                        <div class="page-content">
                            ...
                            <div id="content-area">
                                ...
                                <form class="form-horizontal" action="<?php echo ADMIN_URL; ?>testimonials-remote.php/update/" accept-charset="utf-8" name="suForm" id="suForm" method="post" target="remote" >
                                    ...
                                    <div class="gallery clearfix">
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">    
                                                ...
                                                //Input
                                                $arg = array('type' => $dbs_sulata_testimonials['testimonial__Designation_and_Company_html5_type'], 'name' => 'testimonial__Designation_and_Company', 'id' => 'testimonial__Designation_and_Company', 'autocomplete' => 'off', 'maxlength' => $dbs_sulata_testimonials['testimonial__Designation_and_Company_max'], 'value' => suUnstrip($row['testimonial__Designation_and_Company']), $dbs_sulata_testimonials['testimonial__Designation_and_Company_html5_req'] => $dbs_sulata_testimonials['testimonial__Designation_and_Company_html5_req'], 'class' => 'form-control');
                                                //Placeholder
                                                if ($showLabel == FALSE) {
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">    
                                                ...
                                                echo suDropdown('testimonial__Status', $options, $row['testimonial__Status'], $js)
                                                ?>
                                            </div>
                                        </div>
                                    </div>
