                    ...
                    <div class="container">
                        ...
                        <div class="page-content">
                            ...
                            <div id="content-area">
                                ...
                                <form class="form-horizontal" action="<?php echo ADMIN_URL; ?>media-files-remote.php/add/" accept-charset="utf-8" name="suForm" id="suForm" method="post" target="remote" enctype="multipart/form-data">
                                    ...
                                    <div class="gallery clearfix">
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">        
                                                <label><?php echo $dbs_sulata_media_files['mediafile__Category_req']; ?>Category:
                                                    <?php if ($addAccess == 'true') { ?>    
                                                        <a title="Add new record.." rel="prettyPhoto[iframes]" href="<?php echo ADMIN_URL; ?>media-categories-add.php?overlay=yes&iframe=true&width=80%&height=100%"><img border='0' src='<?php echo BASE_URL; ?>sulata/images/add-icon.png'/></a>
                                            ...
                                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">        
                                                ...
                                                <?php
                                                $arg = array('type' => $dbs_sulata_media_files['mediafile__Picture_html5_type'], 'name' => 'mediafile__Picture', 'id' => 'mediafile__Picture', $dbs_sulata_media_files['mediafile__Picture_html5_req'] => $dbs_sulata_media_files['mediafile__Picture_html5_req']);
                                                echo suInput('input', $arg);
                                                ?>
