...
if (suSegment(1) == 'stream-csv' && $downloadAccessCSV == TRUE) {
    ...
    $fieldsArray = array('setting__Setting', 'setting__Value', 'setting__Type');
    $headerArray = array('Setting', 'Value', 'Type');
                                    ...
                                    <tbody>
                                        <?php foreach ($row as $doc) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo suUnstrip($doc['setting__Setting']); ?></td>
                                                <td><?php echo suUnstrip($doc['setting__Value']); ?></td>
                                                <td><?php echo suUnstrip($doc['setting__Type']); ?></td>

                                                <?php if (($editAccess == TRUE) || ($deleteAccess == TRUE)) { ?>
                                                    <td style="text-align: center;">
                                                        <?php if ($editAccess == TRUE) { ?>
                                                            <a href="<?php echo ADMIN_URL; ?>settings-update.php/<?php echo $doc['_id']; ?>/"><img border="0" src="<?php echo BASE_URL; ?>sulata/images/edit.png" title="<?php echo EDIT_RECORD; ?>"/></a>
                                                        <?php } ?>
                                                        <?php if ($deleteAccess == TRUE) { ?>
                                                            <a onclick="return delRecord(this, '<?php echo CONFIRM_DELETE; ?>')" href="<?php echo ADMIN_URL; ?>settings-remote.php/delete/<?php echo $doc['_id']; ?>/" target="remote"><img border="0" src="<?php echo BASE_URL; ?>sulata/images/delete.png" title="<?php echo DELETE_RECORD; ?>"/></a>
                                                        <?php } ?>
                                                    </td>
                                                <?php } ?>
