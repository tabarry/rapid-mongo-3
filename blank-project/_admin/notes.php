                                    ...
                                    <div class="gallery clearfix">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">                
                                                ...
                                                echo suInput('label', $label, $dbs_sulata_users['user__Notes_req'] . 'Write anything here like things to do, things to remember, etc.', TRUE);
                                                ...
                                                //Placeholder
                                                if ($showLabel == FALSE) {
                                                    $placeholder = array('placeholder' => 'Write anything here like things to do, things to remember, etc.');
