...
$selectedFields = array('page__Name' => 1, 'page__Header' => 1, 'page__Sequence' => 1);
...
if (suSegment(1) == 'stream-csv' && $downloadAccessCSV == TRUE) {
    ...
    $fieldsArray = array('page__Name', 'page__Header', 'page__Sequence');
    $headerArray = array('Name', 'Header', 'Sequence');
                        ...
                        <div class="page-content">
                            ...
                            <div id="content-area">
                                ...
                                <?php if ($addAccess == 'true') { ?>
                                    <div id="table-area"><a href="pages-add.php" class="btn btn-black">Add new..</a></div>
                                <?php } ?>
                                <?php
                                $fieldsArray = array('page__Name_slug', 'page__Header', 'page__Sequence');
                                suSort($fieldsArray);
                                ?>
                                <!-- TABLE -->
                                    ...
                                    <tbody>
                                        <?php foreach ($row as $doc) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo suUnstrip($doc['page__Name']); ?></td>
                                                <td><?php echo suUnstrip($doc['page__Header']); ?></td>
                                                <td><?php echo suUnstrip($doc['page__Sequence']); ?></td>

                                                <?php if (($editAccess == TRUE) || ($deleteAccess == TRUE)) { ?>
                                                    <td style="text-align: center;">
                                                        <?php if ($editAccess == TRUE) { ?>
                                                            <a href="<?php echo ADMIN_URL; ?>pages-update.php/<?php echo $doc['_id']; ?>/"><img border="0" src="<?php echo BASE_URL; ?>sulata/images/edit.png" title="<?php echo EDIT_RECORD; ?>"/></a>
                                                        <?php } ?>
                                                        <?php if ($deleteAccess == TRUE) { ?>
                                                            <a onclick="return delRecord(this, '<?php echo CONFIRM_DELETE; ?>')" href="<?php echo ADMIN_URL; ?>pages-remote.php/delete/<?php echo $doc['_id']; ?>/" target="remote"><img border="0" src="<?php echo BASE_URL; ?>sulata/images/delete.png" title="<?php echo DELETE_RECORD; ?>"/></a>
                                                        <?php } ?>
                                                    </td>
                                                <?php } ?>
