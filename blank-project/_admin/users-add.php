                                    ...
                                    <div class="gallery clearfix">
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">   
                                                ...
                                                //Input
                                                $arg = array('type' => $dbs_sulata_users['user__Phone_html5_type'], 'name' => 'user__Phone', 'id' => 'user__Phone', 'autocomplete' => 'off', 'maxlength' => $dbs_sulata_users['user__Phone_max'], 'value' => '', $dbs_sulata_users['user__Phone_html5_req'] => $dbs_sulata_users['user__Phone_html5_req'], 'class' => 'form-control');
                                                //Placeholder
                                                if ($showLabel == FALSE) {
                                        ...
                                        <?php if ($getSettings['google_login'] != 1) { ?>
                                            <div class="form-group">
                                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">      
                                                    ...
                                                    //Input
                                                    $arg = array('type' => $dbs_sulata_users['user__Password_html5_type'], 'name' => 'user__Password', 'id' => 'user__Password', 'maxlength' => $dbs_sulata_users['user__Password_max'], 'value' => '', $dbs_sulata_users['user__Password_html5_req'] => $dbs_sulata_users['user__Password_html5_req'], 'class' => 'form-control', 'onkeyup' => "doStrongPassword('user__Password','passwordStrength');");
                                                    //Placeholder
                                                    if ($showLabel == FALSE) {
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">                                            
                                                    ...
                                                    //Input
                                                    $arg = array('type' => $dbs_sulata_users['user__Password_html5_type'], 'name' => 'user__Password2', 'id' => 'user__Password2', 'maxlength' => $dbs_sulata_users['user__Password_max'], 'value' => '', $dbs_sulata_users['user__Password_html5_req'] => $dbs_sulata_users['user__Password_html5_req'], 'class' => 'form-control');
                                                    //Placeholder
                                                    if ($showLabel == FALSE) {
