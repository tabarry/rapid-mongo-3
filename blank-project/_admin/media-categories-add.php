                    ...
                    <div class="container">
                        ...
                        <div class="page-content">
                            ...
                            <div id="content-area">
                                ...
                                <form class="form-horizontal" action="<?php echo ADMIN_URL; ?>media-categories-remote.php/add/" accept-charset="utf-8" name="suForm" id="suForm" method="post" target="remote" enctype="multipart/form-data">
                                    ...
                                    <div class="gallery clearfix">
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">                
                                                ...
                                                //Input
                                                $arg = array('type' => $dbs_sulata_media_categories['mediacat__Name_html5_type'], 'name' => 'mediacat__Name', 'id' => 'mediacat__Name', 'autocomplete' => 'off', 'maxlength' => $dbs_sulata_media_categories['mediacat__Name_max'], 'value' => '', $dbs_sulata_media_categories['mediacat__Name_html5_req'] => $dbs_sulata_media_categories['mediacat__Name_html5_req'], 'class' => 'form-control');
                                                //Placeholder
                                                if ($showLabel == FALSE) {
                                            ...
                                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">                
                                                ...
                                                //Input
                                                $arg = array('type' => $dbs_sulata_media_categories['mediacat__Sequence_html5_type'], 'name' => 'mediacat__Sequence', 'id' => 'mediacat__Sequence', 'autocomplete' => 'off', 'maxlength' => $dbs_sulata_media_categories['mediacat__Sequence_max'], 'value' => '', $dbs_sulata_media_categories['mediacat__Sequence_html5_req'] => $dbs_sulata_media_categories['mediacat__Sequence_html5_req'], 'class' => 'form-control');
                                                //Placeholder
                                                if ($showLabel == FALSE) {
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">            
                                                ...
                                                //Input
                                                $arg = array('type' => $dbs_sulata_media_categories['mediacat__Image_Width_html5_type'], 'name' => 'mediacat__Image_Width', 'id' => 'mediacat__Image_Width', 'autocomplete' => 'off', 'maxlength' => $dbs_sulata_media_categories['mediacat__Image_Width_max'], 'value' => '', $dbs_sulata_media_categories['mediacat__Image_Width_html5_req'] => $dbs_sulata_media_categories['mediacat__Image_Width_html5_req'], 'class' => 'form-control');
                                                //Placeholder
                                                if ($showLabel == FALSE) {
                                            ...
                                            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">            
                                                ...
                                                //Input
                                                $arg = array('type' => $dbs_sulata_media_categories['mediacat__Image_Height_html5_type'], 'name' => 'mediacat__Image_Height', 'id' => 'mediacat__Image_Height', 'autocomplete' => 'off', 'maxlength' => $dbs_sulata_media_categories['mediacat__Image_Height_max'], 'value' => '', $dbs_sulata_media_categories['mediacat__Image_Height_html5_req'] => $dbs_sulata_media_categories['mediacat__Image_Height_html5_req'], 'class' => 'form-control');
                                                //Placeholder
                                                if ($showLabel == FALSE) {
