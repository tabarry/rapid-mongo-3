                                    ...
                                    <?php foreach ($row as $doc) { ?>
                                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4" id="card_<?php echo $doc['_id']; ?>">
                                            <div class="card">
                                                <?php if (($editAccess == TRUE) || ($deleteAccess == TRUE)) { ?>
                                                    ...
                                                    <header>
                                                        <?php if ($editAccess == TRUE) { ?>
                                                            ...
                                                            <a href="<?php echo ADMIN_URL; ?>pages-update.php/<?php echo $doc['_id']; ?>/"><i class="fa fa-edit"></i></a>
                                                        <?php } ?>

                                                        <?php if ($deleteAccess == TRUE) { ?>

                                                            <a onclick="return delById('card_<?php echo $doc['_id']; ?>', '<?php echo CONFIRM_DELETE; ?>')" href="<?php echo ADMIN_URL; ?>pages-remote.php/delete/<?php echo $doc['_id']; ?>/" target="remote"><i class="fa fa-trash"></i></a>
                                                        <?php } ?>
                                                ...
                                                <label>Name</label>
                                                <h1><?php
                                                    if (suUnstrip($doc['page__Name']) == '') {
                                                        echo "-";
                                                    } else {
                                                        echo suSubstr(suUnstrip($doc['page__Name']));
                                                    }
                                                    ?></h1>

                                                <label>Header</label>
                                                <p><?php
                                                    if (suUnstrip($doc['page__Header']) == '') {
                                                        echo "-";
                                                    } else {
                                                        echo suUnstrip($doc['page__Header']);
                                                    }
                                                    ?></p>
                                                <label>Sequence</label>
                                                <p><?php
                                                    if (suUnstrip($doc['page__Sequence']) == '') {
                                                        echo "-";
                                                    } else {
                                                        echo suUnstrip($doc['page__Sequence']);
                                                    }
                                                    ?></p>
                                                <div>&nbsp;</div>
