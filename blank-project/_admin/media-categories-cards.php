                        ...
                        <div class="page-content">
                            ...
                            <div id="content-area">
                                    ...
                                    <?php foreach ($row as $doc) { ?>
                                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4" id="card_<?php echo $doc['_id']; ?>">
                                            <div class="card">
                                                <?php if (($editAccess == TRUE) || ($deleteAccess == TRUE)) { ?>
                                                    ...
                                                    <header>
                                                        <?php if ($editAccess == TRUE) { ?>
                                                            ...
                                                            <a href="<?php echo ADMIN_URL; ?>media-categories-update.php/<?php echo $doc['_id']; ?>/"><i class="fa fa-edit"></i></a>
                                                        <?php } ?>

                                                        <?php if ($deleteAccess == TRUE) { ?>

                                                            <a onclick="return delById('card_<?php echo $doc['_id']; ?>', '<?php echo CONFIRM_DELETE; ?>')" href="<?php echo ADMIN_URL; ?>media-categories-remote.php/delete/<?php echo $doc['_id']; ?>/" target="remote"><i class="fa fa-trash"></i></a>
                                                        <?php } ?>
                                                ...
                                                <h1><?php
                                                    if (suUnstrip($doc['mediacat__Name']) == '') {
                                                        echo "-";
                                                    } else {
                                                        echo suSubstr(suUnstrip($doc['mediacat__Name']));
                                                    }
                                                    ?></h1>
                                                <label>Sequence</label>
                                                <p><?php
                                                    if (suUnstrip($doc['mediacat__Sequence']) == '') {
                                                        echo "-";
                                                    } else {
                                                        echo suUnstrip($doc['mediacat__Sequence']);
                                                    }
                                                    ?></p>
                                                <div>&nbsp;</div>
                                ...
                                <?php if ($downloadAccessCSV == TRUE && $numDocs > 0) { ?>
                                    <p>&nbsp;</p>
                                    <p><a target="remote" href="<?php echo ADMIN_URL; ?>media-categories.php/stream-csv/" class="btn btn-black pull-right"><i class="fa fa-file-excel-o"></i> Download CSV</a></p>
                                    <p>&nbsp;</p>
                                    <div class="clearfix"></div>
                                <?php } ?>
                                <?php if ($downloadAccessPDF == TRUE && $numDocs > 0) { ?>
                                    <p>&nbsp;</p>
                                    <p><a target="remote" href="<?php echo ADMIN_URL; ?>media-categories.php/stream-pdf/" class="btn btn-black pull-right"><i class="fa fa-file-pdf-o"></i> Download PDF</a></p>
                                    <p>&nbsp;</p>
                                    <div class="clearfix"></div>
                                <?php } ?>
