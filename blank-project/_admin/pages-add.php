                                    ...
                                    <div class="gallery clearfix">
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">                
                                                ...
                                                //Input
                                                $arg = array('type' => $dbs_sulata_pages['page__Name_html5_type'], 'name' => 'page__Name', 'id' => 'page__Name', 'autocomplete' => 'off', 'maxlength' => $dbs_sulata_pages['page__Name_max'], 'value' => '', $dbs_sulata_pages['page__Name_html5_req'] => $dbs_sulata_pages['page__Name_html5_req'], 'class' => 'form-control');
                                                //Placeholder
                                                if ($showLabel == FALSE) {
                                            ...
                                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">                
                                                ...
                                                //Input
                                                $arg = array('type' => $dbs_sulata_pages['page__Heading_html5_type'], 'name' => 'page__Heading', 'id' => 'page__Heading', 'autocomplete' => 'off', 'maxlength' => $dbs_sulata_pages['page__Heading_max'], 'value' => '', $dbs_sulata_pages['page__Heading_html5_req'] => $dbs_sulata_pages['page__Heading_html5_req'], 'class' => 'form-control');
                                                //Placeholder
                                                if ($showLabel == FALSE) {
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">            
                                                ...
                                                //Input
                                                $arg = array('type' => $dbs_sulata_pages['page__Title_html5_type'], 'name' => 'page__Title', 'id' => 'page__Title', 'autocomplete' => 'off', 'maxlength' => $dbs_sulata_pages['page__Title_max'], 'value' => '', $dbs_sulata_pages['page__Title_html5_req'] => $dbs_sulata_pages['page__Title_html5_req'], 'class' => 'form-control');
                                                //Placeholder
                                                if ($showLabel == FALSE) {
                                            ...
                                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">            
                                                ...
                                                //Input
                                                $arg = array('type' => $dbs_sulata_pages['page__Keyword_html5_type'], 'name' => 'page__Keyword', 'id' => 'page__Keyword', 'autocomplete' => 'off', 'maxlength' => $dbs_sulata_pages['page__Keyword_max'], 'value' => '', $dbs_sulata_pages['page__Keyword_html5_req'] => $dbs_sulata_pages['page__Keyword_html5_req'], 'class' => 'form-control');
                                                //Placeholder
                                                if ($showLabel == FALSE) {
                                            ...
                                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">                
                                                ...
                                                //Input
                                                $arg = array('type' => $dbs_sulata_pages['page__Description_html5_type'], 'name' => 'page__Description', 'id' => 'page__Description', 'autocomplete' => 'off', 'maxlength' => $dbs_sulata_pages['page__Description_max'], 'value' => '', $dbs_sulata_pages['page__Description_html5_req'] => $dbs_sulata_pages['page__Description_html5_req'], 'class' => 'form-control');
                                                //Placeholder
                                                if ($showLabel == FALSE) {
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">            
                                                ...
                                                //Input
                                                $arg = array('type' => $dbs_sulata_pages['page__Sequence_html5_type'], 'name' => 'page__Sequence', 'id' => 'page__Sequence', 'autocomplete' => 'off', 'maxlength' => $dbs_sulata_pages['page__Sequence_max'], 'value' => '', $dbs_sulata_pages['page__Sequence_html5_req'] => $dbs_sulata_pages['page__Sequence_html5_req'], 'class' => 'form-control');
                                                //Placeholder
                                                if ($showLabel == FALSE) {
